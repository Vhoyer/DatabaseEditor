...
namespace Mngrs
{
    class DirMngr
    {
        ...
        /// <returns></returns>
        public static string dpgen(string path)
        {
            string retorno = "";
        ...
        /// <summary>
        /// gera o nome do arquivo sem o caminho completo
        /// </summary>
        /// <param name="path"></param>
        /// <returns></returns>
        public static string fngen(string path)
        {
            string[] sptpath = path.Split(char.Parse(@"\"));
            return sptpath[sptpath.Length - 1];
        }
